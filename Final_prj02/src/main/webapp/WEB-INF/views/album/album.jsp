...
<div class="u-header__section u-header__section--light g-bg-white g-transition-0_3 g-py-10" id="upload_btn">
	<a class="btn btn-secondary g-mr-10 g-mb-15" id="uploadbtn" href="/album/add">upload</a>
</div>
...
<div class="profile__photo-grid">
	<c:forEach var="list" items="${list}">
		<div class="profile__photo">
			...
			<a href="/album/detail?fileName=${list.fileName} "> <img src="${upload1}/${list.fileName}">
			</a>
		</div>
