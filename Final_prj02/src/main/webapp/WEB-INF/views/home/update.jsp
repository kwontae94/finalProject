                ...
                <div class="shortcode-html g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30 ">
                  ...
                  <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"/>
                    ...
                    <div class="form-group row g-mb-25">
                      ...
                      <div class="col-10">
                        <input class="form-control rounded-0 form-control-md" type="text" value="${bean.title }" id="example-text-input" name="title">
                      </div>
                    </div>
                    ...
                    <div class="form-group row g-mb-25">
                      ...
                      <div class="col-10">
                        <input class="form-control rounded-0 form-control-md" type="email" value="${bean.email }" id="example-email-input" name="email">
                      </div>
                    </div>
                    ...
                    <div class="form-group row g-mb-25">
                      ...
                      <div class="col-10">
                        <input class="form-control rounded-0 form-control-md" type="tel" value="${bean.phone }" id="example-tel-input" name="phone">
                      </div>
                    </div>
                    ...
                    <div class="form-group row g-mb-25">
                      ...
                      <div class="col-10">
                        <input class="form-control rounded-0 form-control-md" type="username" value="${bean.user }"  name="user">
                        
                        <input class="form-control rounded-0 form-control-md" type="hidden" value="${bean.id }"  name="id">
                      </div>
                    </div>
                    </c:forEach>
  
			  <div class="container mb-2">
				<button class="btn btn-info btn-block" type="submit">여행록 수정</button>
			  </div>
